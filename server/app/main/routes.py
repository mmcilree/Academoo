...
def change_password():
    req = request.json
    if not (req and "old_password" in req and "new_password" in req):
        return BAD_REQUEST
...
def get_user():
    ...
    for subscription in u.subscriptions:
        subscriptions.append(
            {"communityId": subscription.community_id, "external": subscription.external})
